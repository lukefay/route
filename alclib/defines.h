...
#define EXT_TOL		194				/**< Extension header for FDT content encoding defined by A/331 denoting 24 bit Transport Object Length */
...
#define NRT_FILE_MODE			1	// NRT - FILE MODE: @formatId = 1, @frag = 0, @order = true
#define NRT_ENTITY_MODE			2	// NRT - ENTITY MODE: @formatId = 2, @frag = 0, @order = true
#define NRT_UNSGN_PKG_MODE		3	// NRT - Unsigned Package MODE: @formatId = 3, @frag = 0, @order = true
#define NRT_SGN_PKG_MODE		4	// NRT - Signed Package MODE: @formatId = 4, @frag = 0, @order = true
#define INIT_SEG_TIME_CHG		5	// New Initialization Segment, timeline changed: @formatId = 1, @frag = 0, @order = true
#define INIT_SEG_TIME_CNT		6	// New Initialization Segment, timeline continued: @formatId = 1, @frag = 0, @order = true
#define	INIT_SEG_REDNDNT		7	// Redundant Initialization Segment: @formatId = 1, @frag = 0, @order = true
#define	MEDIA_SEG_FILE			8	// Media Segment, File Mode: @formatId = 1, @frag = 1, @order = true
#define	MEDIA_SEG_ENTITY		9	// Media Segment, Entity Mode: @formatId = 2, @frag = 1, @order = true

// IANA codepoint definitions
#define COM_NO_C_FEC_ENC_ID		0	/**< Compact No-Code FEC scheme RFC 5445 */ 
#define RAPTOR_FEC_ENC_ID		1	/**< RAPTOR FEC scheme RFC 5053 */
#define SIMPLE_XOR_FEC_ENC_ID	2	/**< Simple XOR FEC scheme */
#define LDPC_STAIR_FEC_ENC_ID	3	/**< LDPC Staircase codes FEC scheme RFC 5170 */
#define LDPC_TRI_FEC_ENC_ID		4	/**< LDPC Triangle codes FEC scheme RFC 5170 */
#define RS_FEC_ENC_ID			5	/**< Reed-Solomon codes over GF(2^^8) FEC scheme RFC 5510 */
#define RAPTOR_Q_FEC_ENC_ID		6	/**< RAPTOR Q FEC scheme RFC 6330 */
...
#define EXT_NTP		66		/**< ROUTE Presentation Time Header */
#define EXT_TOLL	67		/**< Extension header for FDT content encoding defined by A/331 denoting 48 bit Transport Object Length */
...
#define MAX_PACKET_LENGTH			1472	/**< Maximum packet length */
...
#define REPAIR			6	/**< REPAIR bits signaled outside Source Flow */
