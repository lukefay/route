...
// Luke Fay unsigned short numEncSymbPerPacket = 1L; /*< The number of symbols per packet. Populated with value entered as argument -Y:value >*/
unsigned long numEncSymbPerPacket = 1L; /*< The number of symbols per packet. Populated with value entered as argument -Y:value >*/
