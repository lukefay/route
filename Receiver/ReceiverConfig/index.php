  ...
  <script>
	...
	function onloadfunc() {
		...
		$.ajax({
			...
			result = JSON.parse(e);
			console.log("**** Setting IP Address: " + result);
			...
			console.log("On Load Function complete: 3done");           
		});
	}
	function Configr() {
		$.ajax({
			...
			console.log("Configuration Complete: 2done");           
		});
	}
	function Set() {
		...
		$.ajax({
			...
			console.log("Set Function Complete: 1done");
		});
	}
